   ...
   if(IsReload==0) this.mainList=[];
    ...
    this.isDisable[obj.master_service_id]=false;
       ...
       //   this.breakDownItem.discount+=(obj.discount_price*element.qty);
          ...
          this.breakDownItem.vat=((this.breakDownItem.total+this.breakDownItem.discount+this.breakDownItem.mebership+parseFloat(this.breakDownItem.tip)  -this.breakDownItem.offer)*parseFloat(vatPercent)).toFixed(2);
...
setTimeout(() => {
  ...
  this.IsLoading=true;
    ...
    if(tip>=0){
      ...
      this.breakDownItem.grandTotal=this.breakDownItem.total+this.breakDownItem.discount+this.breakDownItem.mebership+  this.breakDownItem.tip-this.breakDownItem.offer;
...
setTimeout(() => {
  ...
  ValidCoupon(CouponCode:any,IsLoad:any){
    ...
    this.categoryService.ValidCouponCode(CouponCode).subscribe((obj:any)=>{
      this.breakDownItem.offer=0
